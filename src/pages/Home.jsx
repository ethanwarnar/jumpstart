...
import { Calendar, NavBar, StudentHome, ProfessionalHome, ProNavBar } from '../components'
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Container>
                    {this.props.isStudent && <StudentHome/>}
                    {this.props.isProfessional && <ProfessionalHome/>}

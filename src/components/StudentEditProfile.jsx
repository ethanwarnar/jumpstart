...
class StudentEditProfile extends Component {
    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                <Card body outline style={{ width: "575px", borderRadius: "18px", textAlign: "center", height: "550px", borderColor: "#FFA824", margin: "16vh 0px 0px", borderWidth: "3px" }}>
                    <div style={{ textAlign: "center" }}>
                        <Form>
                            ...
                            <FormGroup row>
                                ...
                                <Col sm={8}>
                                    <Input type="text" name="text" id="exampleText" placeholder="please enter your place of study" />
                                </Col>
                            </FormGroup>
